...
class HeroBrain extends Component with HasGameReference<ColonistGame> {
  ...
  Future<void> _assignTasks() async {
    ...
    if (_queuedTasks.isEmpty || !game.sHero.isIdle) {
      return;
    }
    ...
    try {
      ...
      game.sHero.issueWork(firstDes, path);
    } finally {
      print('end work');
    }
  }
